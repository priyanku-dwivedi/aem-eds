...
var CustomImportScript = (() => {
  ...
  var PAGE_TEMPLATE = {
    name: "contact",
    description: "Contact page: nav header, hero banner, heading, address/email two-column block, map embed, footer.",
    urls: [
      "https://www.888spectate.com/contact.html"
    ],
    blocks: [
      { name: "hero-banner", instances: ["body > header.container__header-banner"] },
      { name: "columns-contact", instances: ["#swup > section.container__section:nth-of-type(1)"] },
      { name: "fragment", instances: ["#swup > section.container__section:nth-of-type(2)"] },
    ...
    sections: [
      ...
      { id: "rc3", name: "contact-heading", selector: ["#swup > h1.container__main-header.container__main-header--larger"], style: null, blocks: [], defaultContent: ["#swup > h1.container__main-header.container__main-header--larger"] },
      { id: "rc4", name: "contact-info", selector: ["#swup > section.container__section:nth-of-type(1)"], style: null, blocks: ["columns-contact"], defaultContent: [] },
      { id: "rc5", name: "map", selector: ["#swup > section.container__section:nth-of-type(2)"], style: null, blocks: ["fragment"], defaultContent: [] }
    ]
  };
  var transformers = [
    transform,
